...
import { FileText, Mail, Lock, Eye, EyeOff, User, Building } from "lucide-react";
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(response.data);
      toast.success(`¡Bienvenido, ${response.data.name}! Tu cuenta ha sido creada.`);
      navigate("/dashboard");
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#F7F6F3] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-bold text-2xl text-gray-900 tracking-tight" style={{ fontFamily: 'Chivo, sans-serif' }}>
            DonatariaSAT
          </span>
        </Link>
        ...
        <Card className="shadow-lg border-gray-100">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              Registra tu organización para comenzar
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">Puedes completar esto después en configuración</p>
              </div>
