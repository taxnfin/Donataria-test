...
@api_router.get("/catalogo/donatarias")
...
@api_router.get("/catalogo/donatarias/giros")
...
@api_router.get("/catalogo/donatarias/{catalogo_id}")
...
@api_router.post("/catalogo/donatarias/import")
...
@api_router.post("/catalogo/donatarias/{catalogo_id}/vincular")
...
@api_router.delete("/catalogo/donatarias/{catalogo_id}/vincular/{donante_id}")
...
@api_router.get("/catalogo/donatarias/{catalogo_id}/vinculados")
...
@api_router.get("/donantes/{donante_id}/catalogo")
...
@api_router.get("/cumplimiento/pdf")
